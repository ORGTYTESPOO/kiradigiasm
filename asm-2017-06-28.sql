...
-- object: grant_ae40d8764d | type: PERMISSION --
GRANT CREATE,USAGE
   ON SCHEMA asm
   TO "asmUser";
-- ddl-end --

-- object: grant_76123f8ef0 | type: PERMISSION --
GRANT CREATE,USAGE
   ON SCHEMA "Maintenance"
   TO "asmUser";
-- ddl-end --

-- object: grant_e5d47766d9 | type: PERMISSION --
GRANT CREATE,USAGE
   ON SCHEMA "History"
   TO "asmUser";
-- ddl-end --

-- object: grant_e2bc60de31 | type: PERMISSION --
GRANT CREATE,USAGE
   ON SCHEMA "Actors"
   TO "asmUser";
-- ddl-end --

-- object: grant_624daf3d62 | type: PERMISSION --
GRANT CREATE,USAGE
   ON SCHEMA "Management"
   TO "asmUser";
-- ddl-end --

-- object: grant_10a1048d6b | type: PERMISSION --
GRANT CREATE,USAGE
   ON SCHEMA "Media"
   TO "asmUser";
-- ddl-end --

-- object: grant_842564c663 | type: PERMISSION --
GRANT CREATE,USAGE
   ON SCHEMA "Reports"
   TO "asmUser";
-- ddl-end --
